...
public interface BankPortType {
    ...
    @RequestWrapper(localName = "chargeCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotel.ws.ChargeCreditCard")
    @ResponseWrapper(localName = "chargeCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotel.ws.ChargeCreditCardResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "validateCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotel.ws.ValidateCreditCard")
    @ResponseWrapper(localName = "validateCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotel.ws.ValidateCreditCardResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "refundCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotel.ws.RefundCreditCard")
    @ResponseWrapper(localName = "refundCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotel.ws.RefundCreditCardResponse")
