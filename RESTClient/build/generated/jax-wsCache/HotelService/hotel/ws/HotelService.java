 ...
 * 
 */
@WebServiceClient(name = "HotelService", targetNamespace = "http://ws.hotel/", wsdlLocation = "http://localhost:8080/Hotel_NiceView/HotelService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICE_QNAME = new QName("http://ws.hotel/", "HotelService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Hotel_NiceView/HotelService?wsdl");
     ...
     * 
     * @return
     *     returns HotelController
     */
    @WebEndpoint(name = "HotelControllerPort")
    public HotelController getHotelControllerPort() {
        return super.getPort(new QName("http://ws.hotel/", "HotelControllerPort"), HotelController.class);
    }
     ...
     */
    @WebEndpoint(name = "HotelControllerPort")
    public HotelController getHotelControllerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.hotel/", "HotelControllerPort"), HotelController.class, features);
    }
